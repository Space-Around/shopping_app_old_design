...
const renderBottomNavCustom = (props) => {
  ...
  const addItemToCart = () => {
    getData("cart").then((response) => {
      ...
      console.log(props.currentViewedItem);
...
const mapStateToProps = (state) => {
  let navigation = state.saveNavigation.navigation,
    ...
    cartItemsComponents = state.cartItemsComponents.cartItemsComponents;

  return { navigation, currentScreen, isActiveAddItemBtn, currentViewedItem, cartItemsComponents };
};
